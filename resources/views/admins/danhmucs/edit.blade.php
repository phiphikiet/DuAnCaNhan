                            ...
                            <div class="row">                                                
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-10 mb-3 d-flex gap-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="trang_thai" id="gridRadios1" value="1" {{ $danhMuc->trang_thai == true ? 'checked' : '' }} checked>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <img id="img_danh_muc" src="{{ Storage::url($danhMuc->hinh_anh) }}" alt="Hình ảnh sản phẩm" style="width: 100px;">
                                        </div>                  
                                    </div>
