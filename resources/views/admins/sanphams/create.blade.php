                            ...
                            <div class="row">                                                
                                    <div class="col-lg-4">  
                                        ...
                                        <div class="mb-3">
                                            ...
                                            value="{{ old('gia_san_pham') }}" placeholder="Gía sản phẩm">
                                            @error('gia_san_pham')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            value="{{ old('gia_khuyen_mai') }}" placeholder="Gía khuyến mãi">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            value="{{ old('ngay_nhap') }}" placeholder="Gía khuyến mãi">
                                            @error('ngay_nhap')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            name="mo_ta_ngan" id="mo_ta_ngan" rows="3" placeholder="Mô tả ngắn">{{ old('mo_ta_ngan') }}</textarea>
                                            @error('mo_ta_ngan')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                                ...
                                                <tbody id="image-table-body">
                                                    <tr>
                                                        <td class="d-flex align-item-center">
                                                            <img id="preview_0" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0Wr3oWsq6KobkPqznhl09Wum9ujEihaUT4Q&s" 
