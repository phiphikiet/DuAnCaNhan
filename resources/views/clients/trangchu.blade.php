...
@section('content')
    ...
    <section class="slider-area">
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="{{ asset('assets/client/img/slider/banner.jpg') }}">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="{{ asset('assets/client/img/slider/banner2.jpg') }}">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="{{ asset('assets/client/img/slider/banner3.jpg') }}">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="row row-20 mtn-20">
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="{{ asset('assets/client/img/banner/anhbannernho1.jpg') }}" alt="product banner">
                        </a>
                ...
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="{{ asset('assets/client/img/banner/anhbannernho2.jpg') }}" alt="product banner">
                        </a>
                ...
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="{{ asset('assets/client/img/banner/anhbannernho3.jpg') }}" alt="product banner">
                        </a>
                        <div class="banner-content text-center">
                ...
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="{{ asset('assets/client/img/banner/anhbannernho4.jpg') }}" alt="product banner">
                        </a>
                        <div class="banner-content text-right">
                    ...
                    <div class="product-banner-carousel slick-row-10">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('assets/client/img/banner/anhduoi1.jpg') }}" alt="product banner">
                                </a>
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('assets/client/img/banner/anhduoi2.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('assets/client/img/banner/anhduoi3.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('assets/client/img/banner/anhduoi4.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('assets/client/img/banner/anhduoi5.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
    ...
    <section class="testimonial-area section-padding bg-img" data-bg="{{ asset('assets/client/img/testimonial/footer.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- section title start -->
